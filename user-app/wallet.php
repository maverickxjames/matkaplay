...
<!-- Mirrored from themes.pixelstrap.com/pwa/taxify/user-app/rental-vehicle-details.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 01 Sep 2024 04:37:14 GMT -->
<head>
    ...
    <header id="header" class="main-header inner-page-header">
        <div class="custom-container">
            <div class="header-panel">
                ...
                <h3 class="fw-semibold title-color">Wallet</h3>
            </div>
        </div>
    </header>
    <!-- header end -->
                ...
                <li>
                    <div class="driver-box outstation-driver-box">
                        ...
                        <div class="grid-btn mt-2">
                            ...
                            <a href="home.html" class="btn theme-btn w-100 m-0">Withdraw</a>
                        </div>
                    </div>
                </li>
            </ul>
